...
const Add = () => {
    return (
<div>
    <h2 className="text-center text-white bg-info m-2">Добавление нового объявления</h2>
    <div className="p-3">
        <form className="w-50 m-auto border border-info p-3 was-validated" style="min-width: 300px;">
            ...
            <div className="mb-3 p-3 border">
                ...
                <input type="file" className="form-control mb-3" id="image1" value="Загрузить изображение" required/>
            ...
            <input type="submit" className="btn btn-info" value="Зарегистрировать"/>
        </form>
    </div>
</div>
